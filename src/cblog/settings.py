...
DATABASES = {
    'default': {
        ...
        'HOST': 'database1.cewc6923iwqz.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'yakupblog' # please enter your s3 bucket name
